-- Advance the public runtime provenance and append-only audit chain to the
-- complete Admin 1.0 read/R1/R2 contract without rewriting older migrations.
...
alter table private.admin_audit_events_v2
  alter column schema_version set default '20260710193000';
...
declare
  ...
  v_schema_version constant text := '20260710193000';
