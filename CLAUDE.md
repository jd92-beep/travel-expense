...
This project is indexed by GitNexus as **travel-expense** (2509 symbols, 4508 relationships, 190 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
