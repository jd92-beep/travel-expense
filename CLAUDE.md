...
> **Workflow routing**: `/Users/tommy/.claude/CLAUDE.md` owns the workflow router, skill discovery, and context boundaries. Route every task through it; do not open `using-superpowers` as a startup habit. This file only adds repo-specific truth.
>
...
>
> The GitNexus block at the bottom is auto-generated by `node .gitnexus/run.cjs analyze` and also appears in `AGENTS.md`. Do not hand-edit either copy.
