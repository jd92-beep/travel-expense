...
This project is indexed by GitNexus as **travel-expense** (8972 symbols, 15320 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
