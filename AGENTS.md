...
This project is indexed by GitNexus as **travel-expense** (2518 symbols, 4553 relationships, 200 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
