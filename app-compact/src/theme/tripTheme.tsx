...
export const TRIP_THEMES: Record<TripThemeKey, ThemeDefinition> = {
  ...
  tokyo_neon: {
    ...
    chart: ['#00F0FF', '#FF2E97', '#FFE66D', '#7CFF6B'], art: 'neon-grid', motion: { ambient: true, duration: '22s' }, chrome: { themeColor: '#0B0416', statusBarStyle: 'light' },
  },
  tropical_candy: {
    ...
    chart: ['#FF3D8A', '#00C2FF', '#FFD93D', '#3DDC97'], art: 'confetti-radial', motion: { ambient: true, duration: '14s' }, chrome: { themeColor: '#fff0f8', statusBarStyle: 'dark' },
  },
  uk_london: {
    ...
    chart: ['#0E2A6B', '#C8102E', '#C9A227', '#1B7A5A'], art: 'union-stripe', motion: { ambient: true, duration: '20s' }, chrome: { themeColor: '#e8eef7', statusBarStyle: 'dark' },
  },
  nordic_aurora: {
    ...
    chart: ['#3DDC97', '#4CC9F0', '#B388FF', '#F72585'], art: 'aurora-bands', motion: { ambient: true, duration: '26s' }, chrome: { themeColor: '#0a1a2e', statusBarStyle: 'light' },
  },
  mexico_fiesta: {
    ...
    chart: ['#E4002B', '#00A86B', '#F2A900', '#6B2D8B'], art: 'papel-picado', motion: { ambient: true, duration: '18s' }, chrome: { themeColor: '#ffe8d6', statusBarStyle: 'dark' },
  },
  india_holi: {
    ...
    chart: ['#E91E63', '#7C4DFF', '#FF6F00', '#00BFA5'], art: 'pigment-splash', motion: { ambient: true, duration: '16s' }, chrome: { themeColor: '#fff3e6', statusBarStyle: 'dark' },
  },
  brazil_carnival: {
    ...
    chart: ['#00A859', '#FFD100', '#0057B8', '#FD0E56'], art: 'parade-float', motion: { ambient: true, duration: '20s' }, chrome: { themeColor: '#06281e', statusBarStyle: 'light' },
  },
};
