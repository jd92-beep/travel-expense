...
export const DEFAULT_TRIP_UPDATE_MODEL_ID = DEFAULT_KIMI_PRIMARY_MODEL_ID;
...
const LEGACY_EMAIL_TRIP_DEFAULTS = new Set(['', 'kimi-code', 'kimi/kimi-for-coding', 'kimi-for-coding', 'mimo/mimo-v2.5-pro', 'mimo/mimo-v2.5']);
