...
const DESTINATION_CONTEXTS: DestinationContext[] = [
  ...
  },
  {
    ...
    pattern: /英國|英国|倫敦|伦敦|\buk\b|london|gbp|england|scotland|wales/i,
  },
  {
    countryCode: 'EU',
    countryName: 'Europe',
  ...
  },
  {
    ...
    primaryCurrency: 'THB',
    themeKey: 'tropical_candy',
    locale: 'th-TH',
    timezone: 'Asia/Bangkok',
    weatherRegion: 'Thailand',
    pattern: /泰國|泰国|曼谷|清邁|清迈|thailand|bangkok|chiang\s*mai|phuket|thb/i,
  },
  {
    countryCode: 'IN',
    countryName: 'India',
    ...
    weatherRegion: 'India',
    pattern: /印度|新德里|孟買|孟买|india|delhi|mumbai|inr/i,
  },
  {
    countryCode: 'MX',
    countryName: 'Mexico',
    primaryCurrency: 'MXN',
    themeKey: 'mexico_fiesta',
    locale: 'es-MX',
    timezone: 'America/Mexico_City',
    weatherRegion: 'Mexico',
    pattern: /墨西哥|mexico|cancun|oaxaca|mxn/i,
  },
  {
    countryCode: 'BR',
    countryName: 'Brazil',
    primaryCurrency: 'BRL',
    themeKey: 'brazil_carnival',
    locale: 'pt-BR',
    timezone: 'America/Sao_Paulo',
    weatherRegion: 'Brazil',
    pattern: /巴西|brazil|rio|sao\s*paulo|brl/i,
  },
  {
    countryCode: 'NO',
    countryName: 'Nordics',
    primaryCurrency: 'NOK',
    themeKey: 'nordic_aurora',
    locale: 'en-GB',
    timezone: 'Europe/Oslo',
    weatherRegion: 'Scandinavia',
    pattern: /挪威|瑞典|芬蘭|芬兰|丹麥|丹麦|iceland|norway|sweden|finland|denmark|reykjavik|oslo|stockholm|nok|sek|dkk/i,
  },
  {
    countryCode: 'MY',
