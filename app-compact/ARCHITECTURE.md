...
- GitHub Pages remains the canonical public legacy deployment. Root `index.html` stays at `/travel-expense/`; the React build is copied to `/travel-expense/compact/`.
