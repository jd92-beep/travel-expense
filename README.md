...
注意：要讓分享 invite 在 live database 真正工作，需要先把 `supabase/migrations/20260612153000_trip_sharing_dual_backend.sql` 套用到 Supabase。不要把 Supabase service role、Notion token 或 invite token 寫入前端或 GitHub。
