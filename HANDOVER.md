...
- Latest compact app-code proof commit: `fd9b3a1` (`Add trip wizard LLM fallback ladder`).
- Latest compact production deployment: Vercel deployment `dpl_8ypkt9eQeAcbgYceSoo242uSknBS`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `9883b825ee87b549`, HTML hash `adadca6efb029204`, and alias/deployment content match for app-code commit `fd9b3a1`.
