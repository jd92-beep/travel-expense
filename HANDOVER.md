...
- Latest compact production deployment: Vercel deployment `dpl_5teg4c1xn7a5hJQURMBYatmgaVVV`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `e2ddae51f4b8345f`, HTML hash `6ede74ee77e0b885`, and alias/deployment content match after app-code commit `9d4a3be`.
