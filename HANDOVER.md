...
- Latest compact app-code proof commit: `ff24cbc` (`Declutter compact records and timeline controls`).
- Latest compact production deployment: Vercel deployment `dpl_FAEsqTEXmDp3TDzu9MAskvQaFREz`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `b37e17c49e3eed11`, HTML hash `14491fd55602658d`, and alias/deployment content match for commit `ff24cbc`.
