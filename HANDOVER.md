...
- Latest compact app-code proof commit: `a2e9b72` (`Harden compact itinerary extraction`).
- Latest compact production deployment: Vercel deployment `dpl_9y7VSDw6f7n1i9FjGixc7BWGFZ1U`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `1f6bd07479b69f86`, HTML hash `283297cb18f8feb9`, and alias/deployment content match for app-code commit `a2e9b72`.
