...
- Latest compact app-code proof commit: `015165d` (`Add compact trip update confirmation modal`).
- Latest compact production deployment: Vercel deployment `dpl_7fsr8nN2MzWwL1e2Faz6yEoqbZaQ`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `0f42ae296e04c912`, HTML hash `6883739dde55a80f`, and alias/deployment content match for app-code commit `015165d`.
