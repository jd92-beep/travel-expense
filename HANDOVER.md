...
- Latest compact app-code proof commit: `1efcf4f` (`Add compact departure checklist`).
- Latest live proof command: `npm run smoke:deploy-live`. Latest proof on 2026-06-09 HKT passed for Vercel deployment `dpl_RjHoxECCHK2BYckYMg2UkEyrttRE`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `f7cb438414cb63fc`, HTML hash `566b9cad52e771fe`, and alias/deployment content match.
