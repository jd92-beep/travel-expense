...
- Latest compact app-code proof commit: `f71fbff` (`Fix compact weather itinerary forecasts`).
- Latest compact production deployment: Vercel deployment `dpl_81o32cF6fgRwNYux3VKuFcMxNAHf`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `dd031820637afe8a`, HTML hash `cd7c0faebd2d419c`, and alias/deployment content match for commit `f71fbff`.
