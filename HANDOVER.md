...
- Latest compact app-code proof commit: `d325709` (`Fix compact trip wizard itinerary creation`).
- Latest compact production deployment: Vercel deployment `dpl_895zhEKvsF7gNzCT86D56WcPTBPR`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `16cf4ea1bc1e64b2`, HTML hash `8707a1fbafc09f87`, and alias/deployment content match for app-code commit `d325709`.
