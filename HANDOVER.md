...
- 2026-06-08 compact P4 progress:
  ...
  - Current compact checklist focus after P7 completion: only P0-05 remains `LIVE`, because full provider-vault proof still requires an authenticated ignored local session/admin/Supabase context via `npm run smoke:broker-vault`; no secrets should be printed or committed.
