...
- Latest compact app-code proof commit: `22bb1f2` (`Declutter compact record diagnostics`).
- Latest compact production deployment: Vercel deployment `dpl_2ZEBiwXihz3VtxsQMQwuEYhzWG93`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `fe55b9edeb9815bd`, HTML hash `40b815df11a40105`, and alias/deployment content match for commit `22bb1f2`.
