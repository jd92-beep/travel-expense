...
- Latest compact app-code proof commit: `7dddb74` (`Sync compact weather live preview`).
- Latest compact production deployment: Vercel deployment `dpl_7Qf6LKbWF4f6n9bwr5XzQeujfvTt`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `eda620ea5513d4bc`, HTML hash `aee2a7f8d63724e1`, and alias/deployment content match for commit `7dddb74`.
