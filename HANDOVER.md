...
- Latest compact app-code proof commit: `9e93aab` (`Use selected trip update model`).
- Latest compact production deployment: Vercel deployment `dpl_3eB3LEyVJ9HbGKtNw6nCMjwh4ABn`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `40852c45340f0a59`, HTML hash `7785563b96aa1a44`, and alias/deployment content match for app-code commit `9e93aab`.
