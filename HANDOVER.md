...
- Latest compact app-code proof commit: `78a7d67` (`Add compact trip scope audit`).
- Latest live proof command: `npm run smoke:deploy-live`. Latest proof on 2026-06-09 HKT passed for Vercel deployment `dpl_3YGbzZGF5B1K8mAik7WmSkvbE4Qo`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `460dc10c94b79fb5`, HTML hash `abf77361d4e077a9`, and alias/deployment content match.
