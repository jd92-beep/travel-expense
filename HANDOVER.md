...
- Latest compact app-code proof commit: `dabb152` (`Prevent compact weather metric truncation`).
- Latest compact production deployment: Vercel deployment `dpl_FobtW3gA4frBxXKg47xhU9M5hKW3`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `4be0e10ad6659974`, HTML hash `aa0d8ccce2a482fa`, and alias/deployment content match for commit `dabb152`.
