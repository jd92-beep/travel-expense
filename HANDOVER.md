...
- Latest compact app-code proof commit: `5ec6112` (`Add compact day readiness scoring`).
- Latest live proof command: `npm run smoke:deploy-live`. Latest proof on 2026-06-09 HKT passed for Vercel deployment `dpl_7HSEFRcyeGw85DDE9BiDoTYJBaZv`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `cea2cb7c6dcdcaf2`, HTML hash `07ec59474c327ef0`, and alias/deployment content match.
