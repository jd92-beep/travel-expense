...
- Latest compact app-code proof commit: `810d3c9` (`Add compact trip snapshot`).
- Latest live proof command: `npm run smoke:deploy-live`. Latest proof on 2026-06-09 HKT passed for Vercel deployment `dpl_DnjLXzyypyXV9uSXsc798LAqAtC3`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `0d031aab99be60f2`, HTML hash `0dd4aa73fcd24a27`, and alias/deployment content match.
