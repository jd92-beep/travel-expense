...
- Latest compact app-code proof commit: `bf5c8c4` (`Prefer official JMA weather in compact`).
- Latest compact production deployment: Vercel deployment `dpl_6SWopzxDZWJJNHjfF7GPTDyJ4YCq`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `7bce869406406666`, HTML hash `59a41dbf91c21e05`, and alias/deployment content match for app-code commit `bf5c8c4`.
