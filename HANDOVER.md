...
- Latest compact app-code proof commit: `09f9cfd` (`Add compact official weather router`).
- Latest compact production deployment: Vercel deployment `dpl_EJruZvEaK3fuh5NCy59WBDymDNrx`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `6ea0fadf667fbca9`, HTML hash `c5df7a9f76b22a89`, and alias/deployment content match for app-code commit `09f9cfd`.
