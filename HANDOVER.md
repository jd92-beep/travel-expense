...
- Latest compact app-code proof commit: `c18111b` (`Fix compact weather card overlays`).
- Latest compact production deployment: Vercel deployment `dpl_F2Mm5VwZQmKSm9LL63jQDfL6WspG`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `536ad6249f14332f`, HTML hash `7f0eb1e35bbfc8f6`, and alias/deployment content match for commit `c18111b`.
