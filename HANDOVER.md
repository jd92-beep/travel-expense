...
- Latest compact app-code proof commit: `3060b85` (`Declutter compact stats budget layout`).
- Latest compact production deployment: Vercel deployment `dpl_PHVAGw1KXvsUEKGUSo6BEyADKRbd`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `9c8c7687429a0251`, HTML hash `b03aa88abf68ff4c`, and alias/deployment content match for app-code commit `3060b85`.
