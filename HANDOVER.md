...
- Latest compact app-code proof commit: `5e1860b` (`Add compact local release notes`).
- Latest live proof command: `npm run smoke:deploy-live`. Latest proof on 2026-06-09 HKT passed for Vercel deployment `dpl_HZdU9RWHCMGSTHe1fGYfYx1wtiPN`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `5117f0dae3b15cfa`, HTML hash `9166263fa6a2ab42`, and alias/deployment content match.
