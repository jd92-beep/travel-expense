...
- Latest compact app-code proof commit: `ce37372` (`Fix compact trip wizard day selector`).
- Latest compact production deployment: Vercel deployment `dpl_GusQKVAHVwrHy5bHhPG4tR7YgSPP`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `7cc97c041c7247d6`, HTML hash `fc47c092f99610ee`, and alias/deployment content match for app-code commit `ce37372`.
