...
- Latest compact app-code proof commit: `2cdb1d5` (`Add compact itinerary receipt reconciliation`).
- Latest live proof command: `npm run smoke:deploy-live`. Latest proof on 2026-06-09 HKT passed for Vercel deployment `dpl_HjZgAoUwDLXTQAZ6Xee5egAzbJqE`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `8a0b517705ad942b`, HTML hash `db6785c7c7060df5`, and alias/deployment content match.
...
- 2026-06-08 compact P4 progress:
  ...
  - Current compact checklist focus: P10-04 is next: add a public-safe diagnostics bundle preview. P0-05 remains `LIVE` because full provider-vault proof is still blocked by Kimi quota, required Google/Gemma model availability, Mimo authenticated provider config, and Wrangler account visibility. Keep broker-vault output redacted and secrets out of git.
