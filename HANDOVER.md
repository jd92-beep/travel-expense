...
- Latest compact app-code proof commit: pending commit for P8-04 (`Add compact private trip-share preview`).
- Latest live proof command: `npm run smoke:deploy-live`. Latest proof on 2026-06-09 HKT passed for Vercel deployment `dpl_CxWB3mbtgL4PhkfvynRqvncdGsF8`, live URL `https://travel-expense-compact.vercel.app/`, HTTP 200, title `旅費 Compact`, asset hash `5584addcbe22acc9`, HTML hash `f39f9fc312575c6f`, and alias/deployment content match.
